  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved consumer as @consumer" do
        ...
        post :create, {:consumer => { "name" => "invalid value" }}, valid_session
        assigns(:consumer).should be_a_new(Consumer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested consumer" do
        ...
        Consumer.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => consumer.to_param, :consumer => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the consumer as @consumer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Consumer.any_instance.stub(:save).and_return(false)
        put :update, {:id => consumer.to_param, :consumer => { "name" => "invalid value" }}, valid_session
        assigns(:consumer).should eq(consumer)
      end
